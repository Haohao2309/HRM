...
public class Employee {
    ...
    private String access_permissions;  // Sửa lại thành kiểu dữ liệu boolean

    // Constructor đầy đủ
    public Employee(int userId, String email, String firstName, String lastName,
                    Date dateOfBirth, String gender, String phoneNumber, String address, Date hireDate, String status, String access_permissions) 
    {
        this.userId = userId;
        this.email = email;
