...
public class homePage extends JPanel{
	...
	public void init() {
		...
		this.add(firtsCart);
//		JLabel labelicon_1 = new JLabel(new ImageIcon(new ImageIcon(getClass().getResource("F:\\download.png")).getImage().getScaledInstance(38, 38, Image.SCALE_DEFAULT)));
...
//		lastCart.add(labelicon_1_2);
    ...
    javax.swing.SwingUtilities.invokeLater(new Runnable() {
        public void run() {
            javax.swing.JFrame frame = new javax.swing.JFrame("Home Page Demo");
            frame.setDefaultCloseOperation(javax.swing.JFrame.EXIT_ON_CLOSE);
            frame.setSize(1150, 720); // điều chỉnh kích thước phù hợp
            ...
            home.chart(); // gọi animation sau khi frame hiển thị
        }
    });
}
